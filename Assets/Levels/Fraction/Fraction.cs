...
public class Fraction : MonoBehaviour
{
    ...
    void Initialization()
    {
        ...
        for (int i = 0; i < howManyFractions; i++)
        {
            ...
            //if (rightNumenatores[i]) 
            //age mosavi budam chi?
            if ((float)rightDenominatores[i] / leftDenominatores[i] == (float)rightNumenatores[i] / leftNumenatores[i])
            {
            ...
            //if (leftDenominatores[i] > rightDenominatores[i])
            //{
            //    if (leftDenominatores[i] / rightDenominatores[i] == leftNumenatores[i] / rightNumenatores[i])
            //    {
            //        if (leftNumenatores[i] > 1)
            //        {
            //            leftNumenatores[i] -= 1;
            ...
            //    }
            //}
            //else if (leftDenominatores[i] <= rightDenominatores[i])
            //{
            //    if (rightDenominatores[i] / leftDenominatores[i] == rightNumenatores[i] / leftNumenatores[i])
            //    {
            //        if (leftNumenatores[i] > 1)
            //        {
            //            leftNumenatores[i] -= 1;
    ...
    public void LeftBtnPressed(int playerIndex)
    {
        ...
        if (!btnPressed)
        {
            ...
            if (ans == 0)
            {
                audioHandler.GetComponent<Music>().PlaySound(0);
                if (playerIndex == 0)
                {
            ...
            {
                audioHandler.GetComponent<Music>().PlaySound(1);
